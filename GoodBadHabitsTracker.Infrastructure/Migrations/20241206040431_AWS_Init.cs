...
{
    /// <inheritdoc />
    public partial class AWS_Init : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepeatDaysOfWeek = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    RepeatDaysOfMonth = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    RepeatInterval = table.Column<int>(type: "int", nullable: false),
                    StartDate = table.Column<DateOnly>(type: "date", nullable: false),
                    ReminderTimes = table.Column<string>(type: "nvarchar(96)", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GroupId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValue: Guid.Empty)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DayResults", x => new { x.HabitId, x.Id });
                    table.ForeignKey(
