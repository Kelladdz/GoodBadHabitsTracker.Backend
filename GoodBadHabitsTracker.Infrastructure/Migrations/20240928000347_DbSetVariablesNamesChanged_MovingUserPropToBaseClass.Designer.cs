...
namespace GoodBadHabitsTracker.Infrastructure.Migrations
{
    ...
    [Migration("20240928000347_DbSetVariablesNamesChanged_MovingUserPropToBaseClass")]
    partial class DbSetVariablesNamesChanged_MovingUserPropToBaseClass
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GoodBadHabitsTracker.Core.Models.Habit.QuitHabit", b =>
                {
                    ...
                    b.ToTable("Habits", t =>
                        {
                            t.Property("IsQuit")
                                .HasColumnName("QuitHabit_IsQuit");
                        });
