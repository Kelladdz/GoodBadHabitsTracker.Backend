...
{
    public sealed class EditQuitHabitCommandValidator : AbstractValidator<EditQuitHabitCommand>
    {
        public EditQuitHabitCommandValidator()
        {
            ...
            RuleFor(x => x.Request.RepeatInterval)
                .Must(x => x == 0).WithMessage("For breaking habit, repeat interval value should be 0.");
